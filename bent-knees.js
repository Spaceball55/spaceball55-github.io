//credit for the math for this one (interesting read, too! https://ocw.mit.edu/courses/physics/8-01x-physics-i-classical-mechanics-with-an-experimental-focus-fall-2002/study-materials/jumping.pdf)
...
//console.log(iPlanet.value)
    ...
    ||dist.value === '') {
        ...
        if(planet.value !== ''){
            f = parseFloat(mass.value)*planets[planetInput]*(parseFloat(dist.value)/(parseFloat(bend.value)/100) + 1); //note: force here is force of gravity
            f_ans = f + " Newtons";
            ans.innerHTML = f_ans; 
            ...
            f = parseFloat(mass.value)*parseFloat(gravity.value)*(parseFloat(dist.value)/(parseFloat(bend.value)/100) + 1); //note: force here is force of gravity
            f_ans = f + " Newtons";
            ans.innerHTML = f_ans; 
            //console.log(Planet.value);
            if(f > 100000){
